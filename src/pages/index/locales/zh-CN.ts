export default {
  ...
  "menu.home": "主页",
  "menu.protect": "关于长臂猿",
  "menu.protect.archive": "认识中国猿",
  "menu.protect.knowledge": "关于长臂猿",
  "menu.programs": "我们的项目",
  "menu.programs.overview": "项目概览",
  ...
  // Work cards labels
  "home.work.card.wild.short": "野外调查",
  "home.work.card.wild.long": "野外调查",
  "home.work.card.community.short": "社区保护",
  "home.work.card.community.long": "社区保护",
  "home.work.card.public.short": "公众倡导",
  ...
  "archive.gibbon7.name": "西白眉长臂猿",
  "archive.gibbon7.family": "长臂猿科",
  "archive.gibbon7.genus": "白眉长臂猿属",
  "archive.gibbon7.iucn": "濒危",
  "archive.gibbon7.chineseLevel": "1级",
  "archive.gibbon7.distribution": "中国、印度、孟加拉、缅甸",
  "archive.gibbon7.amount": "未知",
  "archive.gibbon7.feature":
    '西白眉长臂猿因眼部上方有两道白眉而得名。雌雄异色。雄性黑褐色或暗褐色，白色眉毛不能截然分开，中间有白色毛发相连，下颚和"眼袋"处有稀少的白毛。雌性大部分毛发为灰白或灰黄色，四肢颜色与体色相近，胸部毛发较深，面部及眼下方环有一圈白毛。与冠长臂猿属不同，它们头顶的毛较长，披向后方，故头顶扁平，无直立向上的簇状冠毛。主要为一夫一妻的家庭结构。',
  ...
  "us.report.year": "年",
  "us.report.month": "月",
  "us.report.quarter": "季度",
  "us.report.q1": "第一季度",
  "us.report.q2": "第二季度",
  "us.report.q3": "第三季度",
  "us.report.q4": "第四季度",
  "us.report.download": "下载",

  "us.partner.title": "合作伙伴",
  "us.partner.desc":
    "在多年的保护之旅中，我们有幸拥有了众多并肩作战的合作伙伴，包括基金会、政府、社会机构以及我们项目地所在的中缅边境的傈僳族社区，梨树与拉马河社区，也包括在项目中支持我们的志愿者、捐赠者以及关注者们。",
  ...
  "us.contact.title": "联系我们",
  "us.contact.address": "地址",
  "us.contact.address.content":
    "云南省大理白族自治州大理古城银苍路1号供电局院内2栋1单元1楼1号",
  "us.contact.tel": "电话",
  "us.contact.site": "官网",
  "us.contact.email": "邮件",
  "us.contact.follow": "关注我们",

  // Honor items
  "honor.2016": '入选"创绿家"计划',
  "honor.2017": '入选"劲草伙伴"计划',
  "honor.2019":
    '"守护天行长臂猿的家"项目获得"迈向生态文明，向环保先锋致敬"荣誉',
  "honor.2021.cop15": '"天行长臂猿保护"入选COP15全球生物多样性100+案例',
  "honor.2021.ford": "荣获福特汽车环保奖-年度先锋奖",
  "honor.2024": '"苏典傈僳族乡天行长臂猿社区保护地"入选潜力OECMs入围案例',
};
