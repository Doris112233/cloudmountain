export default {
  ...
  "menu.programs.investigation": "Field Survey & Monitoring of Gibbon",
  "menu.programs.community": "Community-based Conservation",
  "menu.programs.public": "Communication, Outreach and Public Engagement",
  ...
  "home.tree": "Planting trees for Skywalker Hoolock Gibbons",
  ...
  "home.why.content":
    "China has 7 species of gibbons with a total population of less than 1,700 individuals. The tropical and subtropical forest ecosystems where gibbons live are the most biodiverse regions in China. Protecting them is like opening an umbrella that indirectly protects other species living in the same area.",
  "home.why.button": "Learn More",
  "home.work.title": "Our Work",
  "home.work.content":
    "In Southwest China, we have carried out nearly a decade of field surveys and monitoring, community-based conservation, and public education efforts. We have provided scientific data and conservation recommendations on gibbon conservation to relevant nature reserves and forestry and grassland authorities, while also offering the public a wealth of high-quality educational activities and content about gibbons.",
  "home.story.title": "Our Stories",
  "home.story.card1": "Gibbon Cafeteria Survey Program",
  "home.story.card2": "Community Conservation",

  // Work cards labels
  "home.work.card.wild.short": "Surveys",
  "home.work.card.wild.long": "Surveys and Monitoring",
  ...
  "programs.investigation": "Field Survey and Conservation Monitoring",
  ...
  "programs.investigation.outcome.1.1":
    "1. Over 60 participants received professional training in gibbon survey and monitoring techniques;",
  "programs.investigation.outcome.1.2":
    "2. Collaborated with Yongde Daxueshan Nature Reserve and Kunming Natural History Museum of Zoology to conduct public science outreach, reaching more than 3,000 people;",
  "programs.investigation.outcome.1.3":
    "3. Improved the standardization and efficiency of infrared camera data collection and management in the nature reserve, and optimized the monitoring forms;",
  "programs.investigation.outcome.1.4":
    "4. Printed and distributed 2,000 informational leaflets on the Western Black-crested Gibbon during public outreach events, achieving widespread science communication impact.",
  ...
  //community page
  "programs.community": "Community-based Conservation Areas",
  "programs.community.intro.1":
    "We care about gibbons—and also care about the people whose lives are closely tied to gibbon conservation.",
  "programs.community.intro.2":
    "Around the forests where gibbons live, there are communities who share these mountains with them. Truly effective conservation could not happen without the understanding, participation, and support of local communities.",
  ...
  "programs.community.intro.4":
    "Community conservation is not a one-off event—it is the building of a lasting relationship, a process in which people and nature value and respect each other.",

  "programs.community.title.1":
    "Community Surveys around Skywalker Hoolock Gibbon Habitats",
  "programs.community.time.1":
    "September 2019 – April 2020, August 2021 – April 2022",
  "programs.community.activities.1.1":
    "1. Conducted a sociological baseline survey in communities surrounding the Skywalker hoolock gibbon habitat in Yingjiang County.",
  ...
  "programs.community.outcome.1.1":
    "1. Interviewed 271 households across 17 communities surrounding Skywalker hoolock gibbon habitats outside the nature reserve.",
  ...
  "programs.community.title.4":
    "Empowering Lisu Women and Promoting Community Development through Skywalker Hoolock Gibbon Conservation",
  "programs.community.time.4": "2021 – Present",
  "programs.community.activities.4.1":
    "1. Exploration and promotion of the “Eco-Public Affairs Fund” model",
  ...
  "programs.community.outcome.4.2":
    "2. From 2021 to 2024, the Lishu community received over 100,000 yuan through the Eco-Public Affairs Fund, which is managed and operated by the women’s group.",
  ...
  "programs.community.title.5":
    "Restoration and Habitat Quality Improvement of High-Altitude Skywalker Hoolock Gibbon Habitats",
  "programs.community.time.5": "March 2022 – Present",
  "programs.community.activities.5.1":
    "1. Conducted ecological planting on open slopes —-  caused by slash and burn agriculture that used to be a forest area —- located between the gibbon habitats of Lishu and Lama River.",
  ...
  "programs.community.outcome.5.4":
    "4. Trained local villagers in all key steps of nursery cultivation, ecological planting, seedling monitoring, and maintenance, and compiled the Technical Manual for High-Altitude Habitat Restoration of the Skywalke Hoolock Gibbon.",

  //public page
  "programs.public": "Science outreach and Public Engagement",
  "programs.public.intro.1":
    "For people living in cities, gibbons may seem far in distance, but their fate is deeply connected to all of us.",
  ...
  "archive.gibbon7.name": "Western Hoolock Gibbon",
  "archive.gibbon7.family": "Hylobatidae family",
  "archive.gibbon7.genus": "Hoolock genera",
  "archive.gibbon7.iucn": "EN Endangered",
  "archive.gibbon7.chineseLevel":
    "Wildlife under national first-class protection",
  "archive.gibbon7.distribution": "China, India, Bangladesh, Myanmar",
  "archive.gibbon7.amount": "Unknown",
  "archive.gibbon7.feature":
    'The Western Hoolock Gibbon is named after the two distinctive white "eyebrows" above its eyes. Males and females differ in coloration (sexual dimorphism). Males are blackish or dark brown, with white eyebrows that are not clearly separated but connected by pale hairs across the forehead. Sparse white hairs can also be seen on the chin and around the "eye pouches." Females are mostly grayish-white or grayish-yellow, with limbs similar in color to the body, a darker chest, and a white ring of hair encircling the face and below the eyes. Unlike gibbons of the genus Nomascus (crested gibbons), Hoolock gibbons do not have upright crest-like hair. Instead, their crown hair is long and swept backward, giving the head a flatter appearance. Western Hoolock Gibbons live mainly in monogamous family groups.',
  ...
  "us.report.q3": "Q3",
  "us.report.q4": "Q4",
  "us.report.download": "Download",

  "us.partner.title": "Our Partners",
  "us.partner.desc":
  ...
  "us.partner.list.1": "Foundations & NGOs",
  "us.partner.list.2": "Government partners",
  "us.partner.list.3":
    "Local communities (Lishu & Lama River ethnic communities along the China-Myanmar border)",
  "us.partner.list.4":
    "Researchers; Corporate supporters; Individual donors & volunteers",

  "us.partner.1": "Zhilan Foundation  ",
  "us.partner.2": "China Environmental Protection Foundation (CEPF)",
  "us.partner.3": "Beijing Entrepreneurs Environmental Foundation (BEEF) ",
  "us.partner.4": "China Green Foundation",
  "us.partner.5": "Tencent Charity",
  "us.partner.6": "Alipay Philanthropy",
  "us.partner.7": "Paradise International Foundation",
  "us.partner.8": "Yunnan Green Environment Development Foundation ",
  "us.partner.9": "China Merchants Foundation     ",
  "us.partner.10": "One Foundation",
  "us.partner.11": "Vanke Foundation",
  "us.partner.12":
    "JAKET   Naturewin   Huafu   HIbetterme   Jibian Tea Factory  Liangke Huoxiang",
  "us.partner.13": "Xige Winery",
  "us.partner.14": "IUCN (International Union for Conservation of Nature)",
  "us.partner.15": "China Primatological Society (CPS)",

  "us.govpartner.1": "Yunnan Gaoligongshan National Nature Reserve",
  "us.govpartner.2":
    "Yunnan Wuliangshan National Nature Reserve Jingdong Administration Bureau",
  "us.govpartner.3":
    "Yunnan Ailaoshan National Nature Reserve Xinping Administration Bureau",
  "us.govpartner.4": "Yunnan Tongbiguan Provincial Nature Reserve",
  "us.govpartner.5": "Yunnan Yiwu Prefecture-level Nature Reserve",
  "us.govpartner.6": "Yunnan Changning Lancang County-level Nature Reserve",
  "us.govpartner.7": "Yunnan Forestry and Grassland Administration",
  "us.govpartner.8": "Dehong Prefecture Forestry and Grassland Administration",
  "us.govpartner.9": "Dali Prefecture Forestry and Grassland Administration",
  "us.govpartner.10": "Yingjiang County Forestry and Grassland Administration",
  "us.govpartner.11":
    "Dehong Prefecture Publicity Department of the CPC Committee",
  "us.govpartner.12":
    "Dali Prefecture Civil Affairs Bureau Dehong Prefecture Civil Affairs Bureau",
  "us.govpartner.13": "Sudian Township Mengga Primary School",
  "us.govpartner.14": "Sudian Lisu Township People’s Government",
  "us.govpartner.15": "Sudian Lisu Township Mengga Lishu Community",
  "us.govpartner.16": "Sudian Lisu Township Mengga Hexi Community",
  "us.govpartner.17": "Sudian Lisu Township Sudian Village Lamaha Community",
  "us.govpartner.18": "Zhena Township Xiangbaihe Community",

  "us.honor.title": "Honors",

  "us.contact.title": "Contact Us",
  "us.contact.address": "Address",
  "us.contact.address.content":
    "Unit 1, 1st Floor, Building 2 Power Supply Bureau Compound No. 1 Yincang Road Dali Ancient City Dali Bai Autonomous Prefecture Yunnan Province",
  "us.contact.tel": "Tel:",
  "us.contact.site": "Official Website",
  "us.contact.email": "Email:",
  "us.contact.follow": "Follow Us",

  // Honor items
  "honor.2016": 'Selected in "The Green Starters funding scheme"',
  "honor.2017": 'Selected in "The Growing Up Together scheme"',
  "honor.2019":
    '"Protecting the Home of Skywalker Hoolock Gibbons" project honored with the "Toward Ecological Civilization: Salute to Environmental Pioneers" award',
  "honor.2021.cop15":
    '"Skywalker Hoolock Gibbon Conservation" selected as one of COP15\'s "100+ Global Biodiversity Good Practices"',
  "honor.2021.ford":
    "Awarded Ford Motor Conservation Award - Pioneer of the Year",
  "honor.2024":
    "Sudian Lisu Community Conservation Area for Skywalker Hoolock Gibbons listed as a potential OECM (Other Effective Area-based Conservation Measure) by IUCN",
};
